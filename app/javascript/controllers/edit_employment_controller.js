...
export default class extends Controller {
  ...
  connect() {
    ...
    const employerField = this.element.querySelector("#employerEdit");
    const startDateField = this.element.querySelector("#startDateEdit");
    const endDateField = this.element.querySelector("#endDateEdit");
    const saveButton = this.element.querySelector("#employmentSaveButton");
